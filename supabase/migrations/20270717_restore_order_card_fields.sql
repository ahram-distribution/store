-- ============================================================================
-- Migration: Restore Order Card fields (customer_display_address + previous_order_*)
--
-- These 6 fields were present in v3 (20260709_customer_stats_previous_only)
-- but dropped when phase1/phase2 (20260729) overwrote get_unified_orders
-- without merging v3's additions.
--
-- Restores: customer_display_address, previous_order_count,
--           previous_orders_total, previous_order_number,
--           previous_order_date, previous_order_total
-- ============================================================================
...
COMMENT ON FUNCTION public.get_unified_orders IS 'قائمة موحدة للطلبات — مع customer_owner, created_by_name, customer_display_address, previous-order stats';
