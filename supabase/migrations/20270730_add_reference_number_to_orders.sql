-- =============================================================================
-- Migration 20270730: Add Reference Number to Orders
-- =============================================================================
-- Adds a dedicated reference_number column to orders, assigned when an order
-- moves from "submitted" to "reviewing". Backward-compatible: NULL for all
-- existing orders.
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_orders_reference_number
  ON public.orders USING btree (reference_number)
  WHERE reference_number IS NOT NULL;

-- 3. Update governed_change_order_status to accept p_reference_number
...
BEGIN
  ...
  -- Reference number is mandatory when transitioning submitted → reviewing
  IF v_current_status = 'submitted' AND p_new_status = 'reviewing' THEN
...
-- 4. Update get_unified_orders: add reference_number to output + search
...
-- 5. Update get_unified_order (singular): add reference_number to output
