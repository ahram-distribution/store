-- Add current_owner_name to get_unified_order (singular)
-- Needed for ownership transfer visual indicator on Order Detail page.
-- The JOIN on o.owner_id gives the live employee name, not the stale snapshot.
