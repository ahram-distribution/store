-- Fix get_unified_orders: customer sessions see their own orders by customer_id
-- Previously the WHERE clause used employee visibility rules, returning empty for customers
...
COMMENT ON FUNCTION public.get_unified_orders IS 'Unified orders list — customer sessions see own orders by customer_id; employee sessions use visibility rules.';
