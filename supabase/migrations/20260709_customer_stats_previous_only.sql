-- ============================================================================
-- Migration v3: Customer stats exlude current order (previous orders only)
-- ============================================================================
-- Both RPCs now use LATERAL subquery to compute previous-order-only stats
-- per row, excluding the current order from all aggregations.
--
-- New fields in get_unified_orders:
...
--
-- New fields in get_unified_order customer JSON:
--   previous_order_count
--   previous_orders_total
--   previous_order_number
--   previous_order_date
--   previous_order_total
--
-- All fields nullable. Uses idx_orders_customer_created_at.
-- ============================================================================

-- ============================================================================
-- 1. Update get_unified_orders
-- ============================================================================
...
COMMENT ON FUNCTION public.get_unified_orders IS 'قائمة موحدة للطلبات — مع customer_owner, created_by_name, previous-order stats (v3)';

-- ============================================================================
-- 2. Update get_unified_order
-- ============================================================================
...
COMMENT ON FUNCTION public.get_unified_order IS 'مصدر الحقيقة الموحد للطلب — مع previous-order stats v3, Signature واحد: (p_token text, p_id uuid)';