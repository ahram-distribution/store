...
--    Orders with status draft or cancelled are NEVER counted.
-- ============================================================================
...
IMMUTABLE
AS $$
  SELECT p_status NOT IN ('draft', 'cancelled')
$$;

COMMENT ON FUNCTION public.is_order_in_statistics IS 'Canonical statistical rule: determines whether an order participates in statistical calculations. Draft and cancelled orders are excluded. Every statistical module must use this function.';
