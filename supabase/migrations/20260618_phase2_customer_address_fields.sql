-- 20260618_phase2_customer_address_fields.sql
-- Phase 2 — OrderDetailPage Migration
--
-- Enhances get_unified_order with:
--   1. Customer address fields (governorate, city, address_line1/2, lat/lng)
--   2. changed_by_name in status_history (employee full name)
--
-- Backward compatible — 0 frontend consumers exist yet.

-- ============================================================
-- Update get_unified_order — enhanced customer + history
-- ============================================================
DROP FUNCTION IF EXISTS public.get_unified_order(p_token uuid, p_id uuid) CASCADE;
...
-- ============================================================
-- Update get_unified_orders — no changes (unchanged)
-- ============================================================
-- Kept as-is from Phase 1
