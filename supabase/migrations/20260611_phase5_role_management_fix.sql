-- Fix Phase 5 RPCs: p_token must be uuid (not text) to match check_capability signature

DROP FUNCTION IF EXISTS public.governed_create_role;
DROP FUNCTION IF EXISTS public.governed_update_role;
DROP FUNCTION IF EXISTS public.governed_delete_role;
DROP FUNCTION IF EXISTS public.governed_update_role_capabilities;
DROP FUNCTION IF EXISTS public.get_role_capabilities;
