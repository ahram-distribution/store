-- ===============================================================
-- Phase 7: Work Hours Analytics Layer V2
-- Expands get_employee_workday_history with net_minutes,
-- order/sales/collection/new_customer data + rich summary
-- Governance: is_upper_management / get_visible_employee_ids
-- (consistent with 20260722_fix_attendance_rpcs_visibility.sql)
-- ===============================================================
