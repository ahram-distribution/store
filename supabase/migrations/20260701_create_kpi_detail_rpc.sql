-- ================================================================
-- KPI Detail RPC — السجلات التى كوّنت كل رقم
--
-- لكل KPI في تقرير مدير البيع، هذا RPC يرجع السجلات الخام
-- التي كونّت الرقم المعروض.
--
-- المصادر:
--   Orders/Sales   → orders (via resolve_employee_id + submitted_at)
--   Customers      → customers (via resolve_employee_id + created_at)
--   Visits         → visits (via employee_id + check_in_at)
--   Collections    → collections (via resolve_employee_id + created_at)
-- ================================================================
