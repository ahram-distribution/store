-- ============================================================================
-- Migration: Surgical add — restore 6 Order Card fields to get_unified_orders
--
-- Three-way merge:
--   Base:     Current production function (Phase 2 shape)
--   Incoming: 20270717_restore_order_card_fields.sql
--   Result:   Production function + customer_display_address + 5 previous_order_* fields
--
-- Changes (only 4 edits to the function body):
--   1. Customer jsonb_build_object: add 6 fields after created_by_type
--   2. Customer FROM/JOINs:        add customer_addresses + LATERAL subquery
--   3. Employee jsonb_build_object: add 6 fields after created_by_type
--   4. Employee FROM/JOINs:        add customer_addresses + LATERAL subquery
--
-- No business logic changed. No other migrations replayed.
-- ============================================================================
