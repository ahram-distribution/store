-- Add recently_available_at to get_governed_products response
-- so the "جديد" badge works in original company views too.
...
COMMENT ON FUNCTION public.get_governed_products IS 'المنتجات مع دعم البحث والتصفية والترقيم — يمنع ظهور الأصناف بدون سعر لواجهة العملاء — يشمل recently_available_at للشارة';
