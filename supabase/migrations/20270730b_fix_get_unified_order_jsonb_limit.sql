-- =============================================================================
-- Migration 20270730b: Fix get_unified_order — split jsonb_build_object (102 > 100 limit)
-- =============================================================================
-- PostgreSQL limits jsonb_build_object to 100 arguments. The order sub-object
-- had 50 key-value pairs (100 args); adding reference_number made it 51 (102).
-- Fix: split into two halves merged with || operator.
-- =============================================================================
