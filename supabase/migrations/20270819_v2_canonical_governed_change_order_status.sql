-- Re-create governed_change_order_status v5 after dropping all overloads
-- Canonical 8-status workflow: submitted→approved→reviewing→preparing→prepared→delivered
...
BEGIN
  ...
  IF v_is_exceptional AND (p_reason IS NULL OR trim(p_reason) = '') THEN
    RETURN json_build_object('success', false, 'error', E'\u0627\u0644\u0631\u062c\u0627\u0621 \u0625\u062f\u062e\u0627\u0644 \u0633\u0628\u0628 \u0627\u0644\u062a\u063a\u064a\u064a\u0631 \u0627\u0644\u0627\u0633\u062a\u062b\u0646\u0627\u0626\u064a');
  END IF;
