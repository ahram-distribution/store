-- 20260729_orders_unification_phase2.sql
-- Phase 2: Add customer_owner + order_creator to unified RPCs

-- ============================================================
-- 1. Update get_unified_order — add customer_owner + order_creator
-- ============================================================
...
COMMENT ON FUNCTION public.get_unified_orders IS 'قائمة موحدة للطلبات — مع customer_owner, created_by_name';
