  ...
  return (
    <div
      ...
      style={{
        ...
        width: 'calc(100% - 32px)',
        maxWidth: '400px',
        background: 'rgba(var(--theme-navy-rgb), 0.95)',
        color: '#fff',
        borderRadius: '16px',
        padding: '14px 16px',
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} style={{ stroke: 'var(--theme-accent)' }}>
