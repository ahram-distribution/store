...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .sheet { border: 2pt solid #000; display: flex; flex-direction: column; justify-content: center; gap: 5.5mm; padding: 5mm 8mm; }
