...
const statusStyle: Record<string, { bg: string; text: string }> = {
  ...
  sales_manager_approved: { bg: 'bg-blue-50', text: 'text-blue-600' },
  ...
  ready_for_dispatch: { bg: 'bg-emerald-50', text: 'text-emerald-600' },
  sent_to_delivery: { bg: 'bg-emerald-50', text: 'text-emerald-600' },
  dispatched: { bg: 'bg-emerald-50', text: 'text-emerald-600' },
  delivered: { bg: 'bg-emerald-50', text: 'text-emerald-600' },
  deferred: { bg: 'bg-gray-100', text: 'text-gray-500' },
  cancelled: { bg: 'bg-red-50', text: 'text-red-600' },
  stock_review: { bg: 'bg-blue-50', text: 'text-blue-600' },
