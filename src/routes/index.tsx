...
import { ReturnsPage, ReturnDetailPage } from '../pages/returns'
...
import { TierSystemPage } from '../pages/tiers'
import { AuctionsPage, AuctionDetailPage } from '../pages/auctions'
...
import { CreditProgramsPage, CreditApplicationsPage, CreditReviewPage, CustomerCreditPage, CreditManagementPage } from '../pages/credit'
...
import { EmployeesPage, EmployeeProfilePage, HierarchyPage } from '../pages/employees'
...
export function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/returns" element={<ProtectedRoute requireCapability="returns.read"><ReturnsPage /></ProtectedRoute>} />
      <Route path="/returns/:id" element={<ProtectedRoute requireCapability="returns.read"><ReturnDetailPage /></ProtectedRoute>} />
      ...
      <Route path="/employees" element={<ProtectedRoute requireCapability="employees.manage"><EmployeesPage /></ProtectedRoute>} />
